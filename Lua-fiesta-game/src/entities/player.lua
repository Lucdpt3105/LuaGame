...
local function ensureAssets()
    if not idleImage then
        idleImage = love.graphics.newImage("assets/sprites/player/Archer_Idle.png")
        runImage = love.graphics.newImage("assets/sprites/player/Archer_Run.png")
        shootImage = love.graphics.newImage("assets/sprites/player/Archer_Shoot.png")
...
function Player:beginShoot(dirX, dirY)
    dirX, dirY = MathUtils.normalize(dirX, dirY)
...
function Player:update(dt, map)
    ...
    moveX, moveY = MathUtils.normalize(moveX, moveY)
